...
```shell
$ curl -fsSL https://raw.githubusercontent.com/abchatterjee7/abc-spring-boot-skills/refs/heads/main/install.sh | bash
```

### Claude Code

To use globally copy `abc-spring-boot-skills` directory into `~/.claude/skills/` directory.

To use in a project, copy `abc-spring-boot-skills` directory into `{project_root}/.claude/skills/` directory.

For more info refer https://platform.claude.com/docs/en/agents-and-tools/agent-skills/overview

### OpenAI Codex

To use globally copy `abc-spring-boot-skills` directory into `~/.codex/skills/` directory.

To use in a project, copy `abc-spring-boot-skills` directory into `{project_root}/.codex/skills/` directory.

For more info refer https://developers.openai.com/codex/skills/

### Google Gemini CLI

To use globally copy `abc-spring-boot-skills` directory into `~/.gemini/skills/` directory.

To use in a project, copy `abc-spring-boot-skills` directory into `{project_root}/.gemini/skills/` directory.
